...
Technique PlainMapping
{
    Pass
    {
        VertexShader = compile VS_SHADER_MODEL PlainMappingVS();
        PixelShader = compile PS_SHADER_MODEL PlainMappingPS();
    }
}
...
Technique NormalMapping
{
    Pass
    {
        VertexShader = compile VS_SHADER_MODEL NormalMappingVS();
        PixelShader = compile PS_SHADER_MODEL NormalMappingPS();
    }
}
...
Technique ViewMapping
{
    Pass
    {
        VertexShader = compile VS_SHADER_MODEL ViewMappingVS();
        PixelShader = compile PS_SHADER_MODEL ViewMappingPS();
    }
}
